...
export default createComponent({
  ...
  render() {
    ...
    const { message, titleAlign } = this;
    const messageSlot = this.slots();
    const title = this.slots('title') || this.title;
    const Title = title && (
      <div class={bem('header', { isolated: !message && !messageSlot,[titleAlign]: titleAlign })}>
        {title}
      </div>
    );
    ...
    return (
      ...
      >
        <div
          ...
          class={[bem([this.theme,{ description: this.isDescriptionType }]), this.className]}
